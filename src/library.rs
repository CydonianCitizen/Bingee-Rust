//! Deterministic fake media library: the 1,000-record dataset, local search,
//! and the selection policy applied after a search.
//!
//! Plain Rust types with no Slint dependency; `main.rs` maps them to the
//! generated UI structs.
